...
class TestBatchOperations:
    ...
    async def test_batch_upsert_multiple_frames(self, db_session: AsyncSession, sample_png_bytes: bytes):
    ...
    async def test_batch_upsert_with_duplicates(self, db_session: AsyncSession, sample_png_bytes: bytes):
...
class TestGetFramesByDepthRange:
    ...
    async def test_range_query_with_bounds(self, db_session: AsyncSession, sample_png_bytes: bytes):
        ...
        frames = await get_frames_by_depth_range(
            db_session,
            depth_min=150.0,
            depth_max=250.0
        )
    ...
    async def test_range_query_no_lower_bound(self, db_session: AsyncSession, sample_png_bytes: bytes):
    ...
    async def test_range_query_no_upper_bound(self, db_session: AsyncSession, sample_png_bytes: bytes):
...
class TestGetDepthRange:
    ...
    async def test_depth_range_single_frame(self, db_session: AsyncSession, sample_png_bytes: bytes):
    ...
    async def test_depth_range_multiple_frames(self, db_session: AsyncSession, sample_png_bytes: bytes):
...
class TestPerformance:
    ...
    async def test_batch_upsert_1000_frames(self, db_session: AsyncSession, sample_png_bytes: bytes):
    ...
    async def test_query_performance_large_dataset(self, db_session: AsyncSession, sample_png_bytes: bytes):
    ...
    async def test_count_performance_large_dataset(self, db_session: AsyncSession, sample_png_bytes: bytes):
